...
HD_PWD='C:/Users/shinderink/REC/snake/VivadoVideoProcessing/VideoOut/VideoOut.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopDesign_wrapper.tcl -notrace
