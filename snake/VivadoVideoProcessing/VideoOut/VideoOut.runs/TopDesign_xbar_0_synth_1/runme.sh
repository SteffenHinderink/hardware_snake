...
HD_PWD='C:/Users/shinderink/REC/snake/VivadoVideoProcessing/VideoOut/VideoOut.runs/TopDesign_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDesign_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopDesign_xbar_0.tcl
