...
HD_PWD='C:/Users/shinderink/REC/snake/VivadoVideoProcessing/VideoOut/VideoOut.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopDesign_wrapper.tcl
