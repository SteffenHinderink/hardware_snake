...
HD_PWD='C:/Users/shinderink/REC/snake/VivadoVideoProcessing/VideoOut/VideoOut.runs/TopDesign_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDesign_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopDesign_axi_gpio_0_0.tcl
