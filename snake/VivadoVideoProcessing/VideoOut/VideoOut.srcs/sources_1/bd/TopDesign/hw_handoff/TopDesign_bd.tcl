...
proc create_root_design { parentCell } {
  ...
  set mybtn [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 mybtn ]
  ...
  # Create instance: snake_output_0, and set properties
  set snake_output_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:snake_output:1.0 snake_output_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net VideoOut_TMDS_1 [get_bd_intf_ports hdmi_tx] [get_bd_intf_pins VideoOut/TMDS]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports mybtn] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins snake_output_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net snake_output_0_m_axis_video [get_bd_intf_pins VideoOut/videoIn] [get_bd_intf_pins snake_output_0/m_axis_video]

  # Create port connections
  connect_bd_net -net clkPixel_1 [get_bd_pins VideoOut/clkPixel] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins VideoOut/aclkStream] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins snake_output_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins VideoOut/aresetnStream] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins snake_output_0/ap_rst_n]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs snake_output_0/s_axi_AXILiteS/Reg] SEG_snake_output_0_Reg
