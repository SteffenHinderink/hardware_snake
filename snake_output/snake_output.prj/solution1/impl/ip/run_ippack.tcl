...
## Variables
set Top "snake_output"
set TopNoPrefix "snake_output"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "field_V {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axis_video"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 17280071 II x}
