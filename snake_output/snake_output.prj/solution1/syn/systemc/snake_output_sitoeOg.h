...
// ==============================================================
#ifndef __snake_output_sitoeOg__HH__
#define __snake_output_sitoeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(snake_output_sitoeOg) {
    ...
    SC_CTOR(snake_output_sitoeOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
