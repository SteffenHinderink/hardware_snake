...
// ==============================================================
#ifndef __snake_output_dsubbkb__HH__
#define __snake_output_dsubbkb__HH__
#include "ACMP_dsub.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(snake_output_dsubbkb) {
    ...
    SC_CTOR(snake_output_dsubbkb):  ACMP_dsub_U ("ACMP_dsub_U") {
        ACMP_dsub_U.clk(clk);
