...
// ==============================================================
#ifndef __snake_output_ddivdEe__HH__
#define __snake_output_ddivdEe__HH__
#include "ACMP_ddiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(snake_output_ddivdEe) {
    ...
    SC_CTOR(snake_output_ddivdEe):  ACMP_ddiv_U ("ACMP_ddiv_U") {
        ACMP_ddiv_U.clk(clk);
