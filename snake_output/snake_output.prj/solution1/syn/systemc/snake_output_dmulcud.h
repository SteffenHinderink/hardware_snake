...
// ==============================================================
#ifndef __snake_output_dmulcud__HH__
#define __snake_output_dmulcud__HH__
#include "ACMP_dmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(snake_output_dmulcud) {
    ...
    SC_CTOR(snake_output_dmulcud):  ACMP_dmul_U ("ACMP_dmul_U") {
        ACMP_dmul_U.clk(clk);
