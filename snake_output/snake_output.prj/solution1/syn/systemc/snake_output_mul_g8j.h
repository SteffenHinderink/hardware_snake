...
// ==============================================================
#ifndef __snake_output_mul_g8j__HH__
#define __snake_output_mul_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(snake_output_mul_g8j) {
    ...
    SC_CTOR(snake_output_mul_g8j):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
